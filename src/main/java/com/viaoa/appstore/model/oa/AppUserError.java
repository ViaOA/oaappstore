...
public class AppUserError extends OAObject {
    ...
    @OAProperty(displayName = "Date Time", displayLength = 15, isProcessed = true, timeZonePropertyPath = AppUserError.P_AppUserLogin+"."+AppUserLogin.P_TimeZone)
    ...
    @OAProperty(displayName = "Review Note", maxLength = 254, displayLength = 40)
