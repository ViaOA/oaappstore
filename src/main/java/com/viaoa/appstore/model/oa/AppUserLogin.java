...
public class AppUserLogin extends OAObject {
    ...
    @OAColumn(name = "ComputerName", maxLength = 32)
    ...
    @OAProperty(displayName = "Time Zone", maxLength = 60, displayLength = 15, uiColumnLength = 14, isProcessed = true)
    ...
    @OAColumn(name = "HostName", maxLength = 35)
