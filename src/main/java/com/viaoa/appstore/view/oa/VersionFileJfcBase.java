...
public class VersionFileJfcBase implements OAModelJfcInterface {
    protected static Logger LOG = Logger.getLogger(VersionFileJfc.class.getName());
    
    public static final String PP_Display    = OAString.cpp(VersionFile.P_TypeDisplay);
    ...
    // Model
    protected VersionFileModel model;
    ...
    // Search
    protected VersionFileSearchJfc jfcSearch;
    // hub Search
    protected VersionFileSearchJfc jfcSearchHub;
    // Add
    protected VersionFileSearchJfc jfcAdd;
    ...
    public VersionFileJfcBase() {
        this.model = new VersionFileModel();
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    
    public VersionFileJfcBase(Hub<VersionFile> hubVersionFile) {
        this.model = new VersionFileModel(hubVersionFile);
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    public VersionFileJfcBase(VersionFileModel modelVersionFile) {
        if (modelVersionFile == null) this.model = new VersionFileModel();
        else this.model = modelVersionFile;
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    ...
    // Model
    public VersionFileModel getModel() {
        return model;
    }
    ...
    public static Icon getIcon() {
        return Resource.getJarIcon("versionFile.gif");
    }
    public static Icon getTitleIcon() {
        return Resource.getJarIcon("versionFiles.gif");
    }
    ...
    public OAMenuItem createNewMenuItem(Hub<VersionFile> hub) {
        if (!getModel().getAllowNew()) return null;
        OAMenuItem mi = new OAMenuItem(hub, OAMenuItem.NEW) {
            @Override
            public void afterActionPerformed() {
                // VersionFileJfcBase.this.getEditDialog(this).setVisible(true);
                VersionFileJfcBase.this.onNewVersionFileCreated();
    ...
    public OAMenuItem createInsertMenuItem(Hub<VersionFile> hub) {
        if (!getModel().getAllowNew()) return null;
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<VersionFile> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        if (hubRoot == null && OAString.isEmpty(leadingPropertyPath)) {
            hubRoot = getModel().getHub();
        }
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, VersionFile.P_TypeDisplay), hubRoot, getHub()) {
            @Override
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
            ...
            public void onDoubleClick(Object obj, MouseEvent e) {
                VersionFileJfcBase.this.onDoubleClickTreeNode();
            }
            @Override
    ...
    public OAMenuItem createSearchMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), getModel().getDisplayName() + " search ...", Resource.getJarIcon("search.gif"), OAButton.SEARCH) {
            ...
            public Object getSearchObject() {
                VersionFile versionFile = VersionFileJfcBase.this.onSearch();
                return versionFile;
            }
            @Override
            public void afterActionPerformed() {
    ...
    public JMenuItem createHubSearchMenuItem() {
        ...
        mi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                VersionFileJfcBase.this.onHubSearch();
           }
        });
        return mi;
    }
    ...
    public OALabel createLabel() {
        OALabel lbl = new OALabel(getHub(), OAString.cpp(VersionFile.P_TypeDisplay), 15) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                VersionFileJfcBase.this.customizeRenderer(lbl, VersionFileJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
            @Override
            public String getToolTipText(Object object, int row, String defaultValue) {
                return VersionFileJfcBase.this.getToolTipText(VersionFileJfcBase.this.getHub().getAt(row), row, defaultValue);
            }
        };
        lbl.setMaximumColumns(20);
    ...
    protected void customizeRenderer(JLabel lbl, VersionFile versionFile, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
    }
    protected String getToolTipText(VersionFile versionFile, int row, String defaultValue) {
        return defaultValue;
    }
    ...
    public OAComboBox createComboBox() {
        OAComboBox cbo = new OAComboBox(getHub(), OAString.cpp(VersionFile.P_TypeDisplay), 15) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                VersionFileJfcBase.this.customizeRenderer(lbl, VersionFileJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
    ...
    public OAList createList() {
        OAList lst = new OAList(getHub(), OAString.cpp(VersionFile.P_TypeDisplay), 12, 15) {
            @Override
            public void customizeRenderer(JLabel label, JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                VersionFileJfcBase.this.customizeRenderer(label, VersionFileJfcBase.this.getHub().getAt(index), isSelected, cellHasFocus, index, false, false);
            }
        };
        lst.setMinimumColumns(5);
        lst.setMaximumColumns(20);
    ...
    public OATree createSearchTree() {
        ...
        tnode.setIcon(VersionFileJfc.getTitleIcon());
        tree.add(tnode);
        node = new OATreeNode(VersionFileJfc.PP_Display, getHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                VersionFileJfcBase.this.onDoubleClickTreeNode();
            }
        ...
        node.setIcon(VersionFileJfc.getIcon());
        node.setForegroundColorProperty(VersionFileJfc.PP_ForeColor);
        node.setBackgroundColorProperty(VersionFileJfc.PP_BackColor);
        node.setIconColorProperty(VersionFileJfc.PP_IconColor);
        node.setImageProperty(VersionFileJfc.PP_Icon);
        node.setFontProperty(VersionFileJfc.PP_Font);
        node.setMaxImageHeight(20);
        node.setMaxImageWidth(32);
        tnode.add(node);
        return tree;
    ...
    protected String getToolTipText(OATable table, int row, int col, String defaultValue) {
        // VersionFile client = (VersionFile) table.getHub().getAt(row);
        // defaultValue = VersionFileDelegate.getToolTipText(client, true);
        return defaultValue;
    }
    public OATable createTable() {
        Hub<VersionFile> hubTable;
        if (getModel().getAllowTableFilter()) hubTable = new Hub<VersionFile>(VersionFile.class);
        ...
        OATable table = new OATable(hubTable) {
            ...
            public void onDoubleClick() {
                if (VersionFileJfcBase.this.getModel().getAllowGotoEdit()) {
                    VersionFileJfcBase.this.getEditDialog(this).setVisible(true);
                }
            }
        };
        ...
        // table.setColumnProperties(ModelDelegate.getProperties(), "VersionFile");
    ...
    public void createTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        tc = table.addColumn("Type", 15, createTypeComboBox());
        tc = table.addColumn("File Path", 20, createFilePathTextField());
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(VersionFile.P_FilePath));
        }
    }
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        Hub h = OAObjectEnumDelegate.getDisplayNameValues(VersionFile.class, VersionFile.P_Type).createSharedHub();
        h.setLinkHubOnPos(getModel().getHub(), VersionFile.P_Type);
        lbl = new OALabel(h, "");
        tc = table.addColumn("Type", 15, lbl);
        lbl = new OALabel(getHub(), VersionFile.P_FilePath, 22);
        tc = table.addColumn("File Path", 20, lbl);
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(VersionFile.P_FilePath));
        }
    }
    ...
    public void updateToolBar(final JToolBar toolBar, final ToolBarOptions tbo) {
        ...
        if (tbo.bLabel) {
            OALabel lbl = new OALabel(getHub(), OAString.cpp(VersionFile.P_TypeDisplay));
            lbl.setToolTipTextPropertyPath(OAString.cpp(VersionFile.P_TypeDisplay));
            lbl.setMaxCols(20);
            lbl.setFont(lbl.getFont().deriveFont(Font.ITALIC));
        ...
        if (tbo.bFind) {
            ...
            if (txt != null) {
                ...
                lbl.setText("Find:");
                lbl.setToolTipText("Search using Type");
    ...
    public JButton createGotoListButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                VersionFileJfcBase.this.showCardPanel(VersionFileJfcBase.this.CARD_List);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createDownloadButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                VersionFileJfcBase.this.onDownload();
            }
        });
    ...
    protected void onDownload() {
        DownloadDialog dd = new DownloadDialog<VersionFile>(getHub());
        addDownloadProperties(dd);
        dd.download();
    }
    protected void addDownloadProperties(DownloadDialog dd) {
        dd.addProperty("Id", VersionFile.P_Id);
        dd.addProperty("type", VersionFile.P_Type);
        dd.addProperty("filePath", VersionFile.P_FilePath);
    }
    // Card Panel
    ...
    public JPanel createEditPanel(boolean bUseCombinedDetail) {
        ...
        if (getModel().getApplicationVersionModel().getCreateUI()) {
            ...
            gc.gridwidth = gc.REMAINDER;
            gc.fill = gc.HORIZONTAL;
            olbl = createApplicationVersionLabel();
        ...
        lbl = new JLabel("Calc Download Url:");
        gc.anchor = gc.WEST;
        panel.add(lbl, gc);
        gc.anchor = gc.NORTHWEST;
        txt = createCalcDownloadUrlTextField();
        if (getModel().getViewOnly()) txt.getController().setViewOnly(true);
        txt.setLabel(lbl);
        gc.gridwidth = gc.REMAINDER;
        gc.fill = gc.HORIZONTAL;
        ...
        lbl = new JLabel("Calc File Path:");
        gc.anchor = gc.WEST;
        panel.add(lbl, gc);
        gc.anchor = gc.NORTHWEST;
        txt = createCalcFilePathTextField();
        if (getModel().getViewOnly()) txt.getController().setViewOnly(true);
        txt.setLabel(lbl);
        gc.gridwidth = gc.REMAINDER;
        gc.fill = gc.HORIZONTAL;
        ...
        lbl = new JLabel("Calc Is Jar File:");
        gc.anchor = gc.WEST;
        panel.add(lbl, gc);
        gc.anchor = gc.NORTHWEST;
        olbl = createCalcIsJarFileLabel();
        if (getModel().getViewOnly()) olbl.getController().setViewOnly(true);
        olbl.setLabel(lbl);
        gc.gridwidth = gc.REMAINDER;
        gc.fill = gc.HORIZONTAL;
    ...
    public JDialog getEditDialog(Component comp) {
        ...
        VersionFileJfc jfc = new VersionFileJfc(getModel());
    ...
    public OALabel createIdLabel() {
        OALabel lbl = new OALabel(getHub(), VersionFile.P_Id, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), VersionFile.P_Created, 15);
    ...
    public OAComboBox createTypeComboBox() {
        Hub<String> hub = OAObjectEnumDelegate.getDisplayNameValues(VersionFile.class, VersionFile.P_Type).createSharedHub();
        hub.setLinkHubOnPos(getHub(), VersionFile.P_Type);
        OAComboBox cbo = new OAComboBox(hub, "", 15);
        cbo.setMaximumColumns(20);
    ...
    public OATextField createFilePathTextField() {
        OATextField txt = new OATextField(getHub(), VersionFile.P_FilePath, 22);
    ...
    public OALabel createCalcIsJarFileLabel() {
        OALabel lbl = new OACheckBoxLabel(getHub(), VersionFile.P_CalcIsJarFile, 5);
        lbl.setMaximumColumns(5);
        return lbl;
    }
    
    public OATextField createCalcDownloadUrlTextField() {
        OATextField txt = new OATextField(getHub(), VersionFile.P_CalcDownloadUrl, 20);
    ...
    public OATextField createCalcFilePathTextField() {
        OATextField txt = new OATextField(getHub(), VersionFile.P_CalcFilePath, 20);
        txt.getController().getEnabledChangeListener().addAlwaysFalse();
        OAJfcUtil.initializeCalcTextField(txt);
        txt.setMinimumColumns(0);
        txt.setMaximumColumns(120);
    ...
    public OALabel createApplicationVersionLabel() {
        OALabel lbl = getApplicationVersionJfc().createLabel();
        return lbl;
    }
    ...
    public OAAutoCompleteTextField createAutoCompleteTextField(String propertyPath) {
        ...
        txt.setToolTipText("Search using Type");
        return txt;
    }
    ...
    public ApplicationVersionJfc getApplicationVersionJfc() {
        ...
        jfcApplicationVersion = new ApplicationVersionJfc(getModel().getApplicationVersionModel()) {
            @Override
            protected ApplicationVersionSearchJfc getSearchJfc() {
                if (jfcSearch != null) return jfcSearch;
                VersionFileJfcBase.this.getModel().getApplicationVersionSearchModel().getApplicationVersionSearch().setMaxResults(1000);
                jfcSearch = new ApplicationVersionSearchJfc(VersionFileJfcBase.this.getModel().getApplicationVersionSearchModel());
                return jfcSearch;
            }
        };
    ...
    protected void onNewVersionFileCreated() {
        onShowEditPanel();
    }
    ...
    // Inner Search
    public VersionFileSearchJfc getSearchHubJfc() {
        if (jfcSearchHub != null) return jfcSearchHub;
        VersionFileSearchModel modelSearch = new VersionFileSearchModel();
        modelSearch.setSearchFromHub(getHub());
        jfcSearchHub = new VersionFileSearchJfc(modelSearch, true, getModel().getAllowMultiSelect()) {
            @Override
    ...
    protected void onHubSearch() {
        ...
        if (getModel().getAllowMultiSelect()) {
            ...
            for (VersionFile versionFile : getSearchHubJfc().getModel().getMultiSelectHub()) {
                if (getHub().contains(versionFile)) {
                    getModel().getMultiSelectHub().add(versionFile);
                }
            }
            getHub().setAO(getModel().getMultiSelectHub().getAt(0));
        }
        else {
            VersionFile versionFile = getSearchHubJfc().getSelected();
            if (versionFile != null) {
                if (getHub().contains(versionFile)) {
                    getHub().setAO(versionFile);
                }
            }
        }
    }
    // Search
    protected VersionFileSearchJfc getSearchJfc() {
        if (jfcSearch == null) {
            jfcSearch = new VersionFileSearchJfc();
        }
        return jfcSearch;
    }
    protected VersionFile onSearch() {
        getSearchJfc().getModel().beforeInput();
        getSearchJfc().getDialog().setVisible(true);
        VersionFile versionFile = null;
        if (getSearchJfc().wasSelected()) versionFile = getSearchJfc().getSelected();
        return versionFile;
    }
    // Add
    protected VersionFileSearchJfc getAddJfc() {
        if (jfcAdd == null) {
            jfcAdd = new VersionFileSearchJfc();
        }
        return jfcAdd;
    }
    protected void onAdd() {
        ...
        VersionFile versionFile = getAddJfc().getSelected();
    ...
    public static void main(String[] args) {
        ...
        VersionFileJfc ui = new VersionFileJfc() {
            @Override
            protected VersionFileSearchJfc getSearchJfc() {
                if (this.jfcSearch == null) {
                    this.jfcSearch = new VersionFileSearchJfc(false) {
                        @Override
