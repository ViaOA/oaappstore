...
public class AppServerJfcBase implements OAModelJfcInterface {
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<AppServer> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        ...
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, AppServer.P_AppUserLogin, AppUserLogin.P_HostName), hubRoot, getHub()) {
            ...
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
                AppServerJfcBase.this.getCardPanel();
    ...
    public OATree createSearchTree() {
        ...
        tree.add(tnode);
        node = new OATreeNode(AppServerJfc.PP_Display, ModelDelegate.getCreateOneAppServerHub().createSharedHub(), getHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                AppServerJfcBase.this.onDoubleClickTreeNode();
            }
    ...
    public JPanel createEditPanel(boolean bUseCombinedDetail) {
        ...
        panel.add(lbl, gc);
        gc.anchor = gc.NORTHWEST;
        ftxt = createReleaseFormattedTextField();
        if (getModel().getViewOnly()) ftxt.getController().setViewOnly(true);
        ftxt.setLabel(lbl);
        gc.gridwidth = gc.REMAINDER;
        gc.fill = gc.HORIZONTAL;
        comp = new OAResizePanel(ftxt, 95);
        panel.add(comp, gc);
        gc.fill = gc.NONE;
        gc.gridwidth = 1;
    ...
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), AppServer.P_Created, 15);
    ...
    public OADateTimeTextField createStartedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), AppServer.P_Started, 15);
        dttxt.setMinimumColumns(0);
        dttxt.setMaximumColumns(22);
        // setup(dttxt);
        return dttxt;
    ...
    public OAFormattedTextField createReleaseFormattedTextField() {
        //  mask, legal chars, right-justified, allow spaces
        OAFormattedTextField ftxt = new OAFormattedTextField(getHub(), AppServer.P_Release, 18, "#", "", true, true);
        return ftxt;
    }
    ...
    public JButton createAppUserLoginCommand() {
        ...
        cmd = getAppUserLoginJfc().createSearchButton(true);
        if (cmd != null) {
            ((OAButton)cmd).getController().setViewOnly(getModel().getViewOnly());
            cmd.setText("Search ...");
            mscmd.addButton(cmd);
