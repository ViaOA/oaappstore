...
public class ClientAppJfcBase implements OAModelJfcInterface {
    protected static Logger LOG = Logger.getLogger(ClientAppJfc.class.getName());
    
    public static final String PP_Display    = OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_CalcName);
    ...
    // Model
    protected ClientAppModel model;
    ...
    // hub Search
    protected ClientAppSearchJfc jfcSearchHub;
    // Add
    protected ClientAppSearchJfc jfcAdd;
    ...
    public ClientAppJfcBase(Hub<ClientApp> hubClientApp) {
        this.model = new ClientAppModel(hubClientApp);
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    public ClientAppJfcBase(ClientAppModel modelClientApp) {
        if (modelClientApp == null) this.model = new ClientAppModel();
        else this.model = modelClientApp;
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    ...
    // Model
    public ClientAppModel getModel() {
        return model;
    }
    ...
    public static Icon getIcon() {
        return Resource.getJarIcon("clientApp.gif");
    }
    public static Icon getTitleIcon() {
        return Resource.getJarIcon("clientApps.gif");
    }
    ...
    public OAMenuItem createNewMenuItem(Hub<ClientApp> hub) {
        if (!getModel().getAllowNew()) return null;
        OAMenuItem mi = new OAMenuItem(hub, OAMenuItem.NEW) {
            @Override
            public void afterActionPerformed() {
                // ClientAppJfcBase.this.getEditDialog(this).setVisible(true);
                ClientAppJfcBase.this.onNewClientAppCreated();
    ...
    public OAMenuItem createInsertMenuItem(Hub<ClientApp> hub) {
        if (!getModel().getAllowNew()) return null;
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<ClientApp> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        if (hubRoot == null && OAString.isEmpty(leadingPropertyPath)) {
            hubRoot = getModel().getHub();
        }
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, ClientApp.P_ServerApplication, ServerApplication.P_CalcName), hubRoot, getHub()) {
            @Override
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
                ClientAppJfcBase.this.getCardPanel();
                ClientAppJfcBase.this.onShowEditPanel();
            }
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                ClientAppJfcBase.this.onDoubleClickTreeNode();
            }
            @Override
    ...
    public OAMenuItem createSearchMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), getModel().getDisplayName() + " search ...", Resource.getJarIcon("search.gif"), OAButton.SEARCH) {
            ...
            public Object getSearchObject() {
                ClientApp clientApp = ClientAppJfcBase.this.onSearch();
                return clientApp;
            }
            @Override
            public void afterActionPerformed() {
    ...
    public JMenuItem createHubSearchMenuItem() {
        ...
        mi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ClientAppJfcBase.this.onHubSearch();
           }
        });
        return mi;
    }
    ...
    public OALabel createLabel() {
        OALabel lbl = new OALabel(getHub(), OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_CalcName), 15) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                ClientAppJfcBase.this.customizeRenderer(lbl, ClientAppJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
            @Override
            public String getToolTipText(Object object, int row, String defaultValue) {
                return ClientAppJfcBase.this.getToolTipText(ClientAppJfcBase.this.getHub().getAt(row), row, defaultValue);
            }
        };
    ...
    protected void customizeRenderer(JLabel lbl, ClientApp clientApp, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
    }
    protected String getToolTipText(ClientApp clientApp, int row, String defaultValue) {
        return defaultValue;
    }
    ...
    public OAComboBox createComboBox() {
        OAComboBox cbo = new OAComboBox(getHub(), OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_CalcName), 15) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                ClientAppJfcBase.this.customizeRenderer(lbl, ClientAppJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
    ...
    public OAList createList() {
        OAList lst = new OAList(getHub(), OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_CalcName), 12, 15) {
            @Override
            public void customizeRenderer(JLabel label, JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                ClientAppJfcBase.this.customizeRenderer(label, ClientAppJfcBase.this.getHub().getAt(index), isSelected, cellHasFocus, index, false, false);
            }
        };
    ...
    public OATree createSearchTree() {
        ...
        tnode.setIcon(ClientAppJfc.getTitleIcon());
        tree.add(tnode);
        node = new OATreeNode(ClientAppJfc.PP_Display, getHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                ClientAppJfcBase.this.onDoubleClickTreeNode();
            }
        ...
        node.setIcon(ClientAppJfc.getIcon());
        node.setForegroundColorProperty(ClientAppJfc.PP_ForeColor);
        node.setBackgroundColorProperty(ClientAppJfc.PP_BackColor);
        node.setIconColorProperty(ClientAppJfc.PP_IconColor);
        node.setImageProperty(ClientAppJfc.PP_Icon);
        node.setFontProperty(ClientAppJfc.PP_Font);
        node.setMaxImageHeight(20);
        node.setMaxImageWidth(32);
        tnode.add(node);
        return tree;
    ...
    protected String getToolTipText(OATable table, int row, int col, String defaultValue) {
        // ClientApp client = (ClientApp) table.getHub().getAt(row);
        // defaultValue = ClientAppDelegate.getToolTipText(client, true);
        return defaultValue;
    }
    public OATable createTable() {
        Hub<ClientApp> hubTable;
        if (getModel().getAllowTableFilter()) hubTable = new Hub<ClientApp>(ClientApp.class);
        ...
        OATable table = new OATable(hubTable) {
            ...
            public void onDoubleClick() {
                if (ClientAppJfcBase.this.getModel().getAllowGotoEdit()) {
                    ClientAppJfcBase.this.getEditDialog(this).setVisible(true);
                }
            }
        };
        ...
        // table.setColumnProperties(ModelDelegate.getProperties(), "ClientApp");
    ...
    public void createTableColumns(OATable table) {
        ...
        if (getModel().getServerApplicationModel().getCreateUI()) {
            lbl = new OALabel(getHub(), OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_Server, Server.P_Environment, Environment.P_Name));
            if (EnvironmentJfc.PP_IconColor != null) {
                lbl.setIconColorProperty(OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_Server, Server.P_Environment) + "." + EnvironmentJfc.PP_IconColor);
            }
            if (EnvironmentJfc.PP_Icon != null) {
                lbl.setImageProperty(OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_Server, Server.P_Environment) + "." + EnvironmentJfc.PP_Icon);
            }
            lbl.setToolTipText("Environment");
            tc = table.addColumn("Env", 15, lbl);
        }
        if (getModel().getServerApplicationModel().getCreateUI()) {
            lbl = new OALabel(getHub(), OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_Server, Server.P_CalcName));
            if (ServerJfc.PP_IconColor != null) {
                lbl.setIconColorProperty(OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_Server) + "." + ServerJfc.PP_IconColor);
            }
            if (ServerJfc.PP_Icon != null) {
                lbl.setImageProperty(OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_Server) + "." + ServerJfc.PP_Icon);
            }
            tc = table.addColumn("Server", 22, lbl);
        }
        tc = table.addColumn("App Name", 16, createCalcNameTextField());
        tc.setToolTipText("Calc Name");
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(ClientApp.P_CalcName));
        }
        if (getModel().getServerApplicationModel().getCreateUI()) {
            lbl = new OALabel(getHub(), OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_ApplicationType, ApplicationType.P_Name));
            if (ApplicationTypeJfc.PP_IconColor != null) {
                lbl.setIconColorProperty(OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_ApplicationType) + "." + ApplicationTypeJfc.PP_IconColor);
            }
            if (ApplicationTypeJfc.PP_Icon != null) {
                lbl.setImageProperty(OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_ApplicationType) + "." + ApplicationTypeJfc.PP_Icon);
            }
            lbl.setToolTipText("Application Type");
            tc = table.addColumn("App Type", 16, lbl);
        }
        if (getModel().getServerApplicationModel().getCreateUI()) {
            lbl = new OALabel(getHub(), ClientAppPP.serverApplication().calcClientPort(), 6);
            lbl.setToolTipText("Server Application Calc Client Port");
            lbl.setFormat("###");
            tc = table.addColumn("Port", 4, lbl);
            if (getModel().getAllowTableFilter()) {
                tc.setFilterComponent(new OATextFieldFilter(ClientAppPP.serverApplication().calcClientPort()));
            }
        }
    }
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        ...
        lbl = new OALabel(getHub(), ClientApp.P_CalcName, 15);
        lbl.setToolTipText("Calc Name");
        tc = table.addColumn("App Name", 16, lbl);
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(ClientApp.P_CalcName));
        }
        lbl = new OALabel(getHub(), OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_ApplicationType, ApplicationType.P_Name));
    ...
    public void updateToolBar(final JToolBar toolBar, final ToolBarOptions tbo) {
        ...
        if (tbo.bLabel) {
            OALabel lbl = new OALabel(getHub(), OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_CalcName));
            lbl.setToolTipTextPropertyPath(OAString.cpp(ClientApp.P_ServerApplication, ServerApplication.P_CalcName));
            lbl.setMaxCols(20);
            lbl.setFont(lbl.getFont().deriveFont(Font.ITALIC));
        ...
        if (tbo.bFind) {
            ...
            if (txt != null) {
                ...
                lbl.setText("Find:");
                lbl.setToolTipText("enter client app name, server app name or app type");
    ...
    public void addCustomCommands(JToolBar toolBar) {
        ...
        toolBar.add(createClientAppRunMethodButton());
    }
    ...
    public JButton createGotoListButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ClientAppJfcBase.this.showCardPanel(ClientAppJfcBase.this.CARD_List);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createDownloadButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                ClientAppJfcBase.this.onDownload();
            }
        });
    ...
    protected void onDownload() {
        DownloadDialog dd = new DownloadDialog<ClientApp>(getHub());
        addDownloadProperties(dd);
        dd.download();
    }
    protected void addDownloadProperties(DownloadDialog dd) {
        dd.addProperty("Id", ClientApp.P_Id);
        dd.addProperty("serverApplication.server.environment.id", ClientAppPP.serverApplication().server().environment().id());
        dd.addProperty("serverApplication.server.environment.name", ClientAppPP.serverApplication().server().environment().name());
        dd.addProperty("serverApplication.server.id", ClientAppPP.serverApplication().server().id());
        dd.addProperty("serverApplication.server.calcName", ClientAppPP.serverApplication().server().calcName());
        dd.addProperty("calcName", ClientApp.P_CalcName);
        dd.addProperty("serverApplication.applicationType.id", ClientAppPP.serverApplication().applicationType().id());
        dd.addProperty("serverApplication.applicationType.name", ClientAppPP.serverApplication().applicationType().name());
        dd.addProperty("serverApplication.calcClientPort", ClientAppPP.serverApplication().calcClientPort());
    }
    // Card Panel
    ...
    public JPanel createEditPanel(JTabbedPane tabbedPane, final boolean bUseCombinedDetail) {
        ...
        lbl = new JLabel("Calc Name:");
        gc.anchor = gc.WEST;
        panel.add(lbl, gc);
        gc.anchor = gc.NORTHWEST;
        txt = createCalcNameTextField();
        if (getModel().getViewOnly()) txt.getController().setViewOnly(true);
        txt.setLabel(lbl);
        gc.gridwidth = gc.REMAINDER;
        gc.fill = gc.HORIZONTAL;
        ...
        if (getModel().getServerApplicationModel().getCreateUI()) {
            lbl = new JLabel("Server Application:");
            gc.anchor = gc.WEST;
            panel.add(lbl, gc);
            gc.anchor = gc.NORTHWEST;
            gc.gridwidth = gc.REMAINDER;
            gc.fill = gc.HORIZONTAL;
            olbl = createServerApplicationLabel();
            if (getModel().getViewOnly()) olbl.getController().setViewOnly(true);
            OAJfcControllerFactory.createOnlyAoNotNull(getHub(), lbl);
            cmd = createServerApplicationCommand();
            comp = olbl;
            comp = new OAResizePanel(comp, cmd);
            panel.add(comp, gc);
            gc.gridwidth = 1;
        ...
        lbl = new JLabel("Auto Login:");
        gc.anchor = gc.WEST;
        panel.add(lbl, gc);
        gc.anchor = gc.NORTHWEST;
        chk = createAutoLoginCheckBox();
    ...
    public OALabel createIdLabel() {
        OALabel lbl = new OALabel(getHub(), ClientApp.P_Id, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), ClientApp.P_Created, 15);
    ...
    public OACheckBox createAutoLoginCheckBox() {
        OACheckBox chk = new OACheckBox(getHub(), ClientApp.P_AutoLogin);
        // chk.setText("Auto Login")
        return chk;
    }
    
    public OATextField createCalcNameTextField() {
        OATextField txt = new OATextField(getHub(), ClientApp.P_CalcName, 15);
    ...
    public OAButton createClientAppRunMethodButton() {
        OAButton cmd = new OAButton(getHub(), "Run", getModel().getAllowMultiSelect() ? OAButton.HUB_METHOD : OAButton.OBJECT_METHOD) { 
            @Override
            public boolean onActionPerformed() throws Exception {
                if (ClientAppJfcBase.this.getModel().getAllowMultiSelect() && ClientAppJfcBase.this.getModel().getMultiSelectHub().getSize() > 0) {
                    for (ClientApp clientApp : ClientAppJfcBase.this.getModel().getMultiSelectHub()) {
                        if (!performAction(clientApp)) return false;
                    }
                }
                else {
                    ClientApp clientApp = ClientAppJfcBase.this.getHub().getAO();
                    performAction(clientApp);
                }
                return true;
            }
            boolean performAction(ClientApp clientApp) throws Exception {
    ...
    public OALabel createServerApplicationLabel() {
        OALabel lbl = getServerApplicationJfc().createLabel();
        return lbl;
    }
    public JButton createServerApplicationCommand() {
        JButton cmd = null;
        OAMultiButtonSplitButton mscmd = new OAMultiButtonSplitButton();
        mscmd.setShowTextInSelectedButton(true);
        mscmd.setAllowChangeMasterButton(false);
        ...
        mscmd.setFocusPainted(false);
        OAButton.setup(mscmd);
        cmd = getServerApplicationJfc().createGotoEditButton();
        if (cmd != null) {
            ((OAButton)cmd).getController().setViewOnly(getModel().getViewOnly());
            mscmd.addButton(cmd);
        }
        ((OAButton)cmd).getController().setViewOnly(getModel().getViewOnly());
        cmd = getServerApplicationJfc().createSearchButton(true);
        if (cmd != null) {
            ((OAButton)cmd).getController().setViewOnly(getModel().getViewOnly());
            cmd.setText("Search ...");
            mscmd.addButton(cmd);
    ...
    public OAAutoCompleteTextField createAutoCompleteTextField(String propertyPath) {
        ...
        txt.setToolTipText("enter client app name, server app name or app type");
        txt.setSearchTemplate("<%=name%>, <%=serverApplication.server.calcName%>, <%=serverApplication.applicationType.name%>");
        return txt;
    }
    ...
    public AppUserJfc getAppUserJfc() {
        ...
        jfcAppUser = new AppUserJfc(getModel().getAppUserSelectFromModel()) {
            ...
            protected AppUserSearchJfc getSearchJfc() {
                ...
                ClientAppJfcBase.this.getModel().getAppUserSearchModel().getAppUserSearch().setMaxResults(1000);
                jfcSearch = new AppUserSearchJfc(ClientAppJfcBase.this.getModel().getAppUserSearchModel());
                return jfcSearch;
            }
        };
    ...
    public ServerApplicationJfc getServerApplicationJfc() {
        if (jfcServerApplication != null) return jfcServerApplication;
        jfcServerApplication = new ServerApplicationJfc(getModel().getServerApplicationSelectFromModel()) {
            @Override
            protected ServerApplicationSearchJfc getSearchJfc() {
                if (jfcSearch != null) return jfcSearch;
                ClientAppJfcBase.this.getModel().getServerApplicationSearchModel().getServerApplicationSearch().setMaxResults(1000);
                jfcSearch = new ServerApplicationSearchJfc(ClientAppJfcBase.this.getModel().getServerApplicationSearchModel());
                return jfcSearch;
            }
        };
        jfcServerApplication.setLevel(getLevel()+1);
    ...
    // Inner Search
    public ClientAppSearchJfc getSearchHubJfc() {
        if (jfcSearchHub != null) return jfcSearchHub;
        ClientAppSearchModel modelSearch = new ClientAppSearchModel();
        modelSearch.setSearchFromHub(getHub());
        jfcSearchHub = new ClientAppSearchJfc(modelSearch, true, getModel().getAllowMultiSelect()) {
            @Override
    ...
    protected void onHubSearch() {
        ...
        if (getModel().getAllowMultiSelect()) {
            ...
            for (ClientApp clientApp : getSearchHubJfc().getModel().getMultiSelectHub()) {
                if (getHub().contains(clientApp)) {
                    getModel().getMultiSelectHub().add(clientApp);
                }
            }
            getHub().setAO(getModel().getMultiSelectHub().getAt(0));
        }
        else {
            ClientApp clientApp = getSearchHubJfc().getSelected();
            if (clientApp != null) {
                if (getHub().contains(clientApp)) {
                    getHub().setAO(clientApp);
                }
            }
        }
    }
    // Search
    protected ClientAppSearchJfc getSearchJfc() {
        if (jfcSearch == null) {
            jfcSearch = new ClientAppSearchJfc();
        }
        return jfcSearch;
    }
    protected ClientApp onSearch() {
        getSearchJfc().getModel().beforeInput();
        getSearchJfc().getDialog().setVisible(true);
        ClientApp clientApp = null;
        if (getSearchJfc().wasSelected()) clientApp = getSearchJfc().getSelected();
        return clientApp;
    }
    // Add
    protected ClientAppSearchJfc getAddJfc() {
        if (jfcAdd == null) {
            jfcAdd = new ClientAppSearchJfc();
        }
        return jfcAdd;
    }
    protected void onAdd() {
        ...
        ClientApp clientApp = getAddJfc().getSelected();
    ...
    public static void main(String[] args) {
        ...
        ClientAppJfc ui = new ClientAppJfc() {
            @Override
            protected ClientAppSearchJfc getSearchJfc() {
                if (this.jfcSearch == null) {
                    this.jfcSearch = new ClientAppSearchJfc(false) {
                        @Override
