        ...
        if (bMultiSelect) table.setMultiSelectControlKey(true);
            ...
            pan.getActionMap().put(cmdName, new AbstractAction() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (appServer != null) onSelect(appServer, hub);
                }
            });
        }
        return pan;
        ...
        if (!bMultiSelect) {
            ...
            pan.getActionMap().put(cmdName, new AbstractAction() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (appServer != null) onSelect(appServer, model.getHub());
                }
            });
            pan.add(panx, BorderLayout.SOUTH);
        }
        ...
        OATable table = new OATable(hubx) {
            ...
            public void onDoubleClick() {
                if (AppServerSearchJfc.this.getModel().getMultiSelectHub() != hubAppServer) {
                    ...
                    if (appServer != null) onSelect(appServer, hubAppServer);
                }
            }
        };
    ...
    protected void onSearch(final JComponent compFrom) {
        ...
        */
        ...
        if (dlgWait.wasCancelled()) {
            ...
            int max = getModel().getAppServerSearch().getMaxResults();
            if (max > 0 && getHub().getSize() == max) {
                String msg = "Selected the first (max="+max+") App Servers.";
                JOptionPane.showMessageDialog(SwingUtilities.getWindowAncestor(compFrom),
                    msg, "AppServer Search",
