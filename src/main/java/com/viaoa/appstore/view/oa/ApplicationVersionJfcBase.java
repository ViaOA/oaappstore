...
public class ApplicationVersionJfcBase implements OAModelJfcInterface {
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<ApplicationVersion> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        ...
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, ApplicationVersion.P_Version), hubRoot, getHub()) {
            ...
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
                ApplicationVersionJfcBase.this.getCardPanel();
    ...
    public void createTableColumns(OATable table) {
        ...
        tc = table.addColumn("Verified", 15, createVerifiedDateTimeTextField());
    }
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        ...
        lbl = new OALabel(getHub(), ApplicationVersion.P_Verified, 15);
        tc = table.addColumn("Verified", 15, lbl);
    }
    ...
    protected void addDownloadProperties(DownloadDialog dd) {
        ...
        dd.addProperty("verified", ApplicationVersion.P_Verified);
    }
    // Card Panel
    ...
    public JPanel createEditPanel(JTabbedPane tabbedPane, final boolean bUseCombinedDetail) {
        ...
        if (getModel().getVersionFilesModel().getCreateUI()) {
            if ((this.TAB_VersionFiles = tabbedPane.getTabCount()) == 0) {
                ...
                tabbedPane.addTab("Files", icon, new JLabel("loading ...", Resource.getJarIcon("wait.png"), JLabel.CENTER), "Version Files");
            }
        }
        panel = panMain;
        return panel;
    ...
    public void showCardPanel(String name) {
        ...
        if (name.equalsIgnoreCase(CARD_VersionFiles)) {
