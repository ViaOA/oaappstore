...
public class SingleAppJfcBase implements OAModelJfcInterface {
    protected static Logger LOG = Logger.getLogger(SingleAppJfc.class.getName());
    
    public static final String PP_Display    = OAString.cpp(SingleApp.P_ApplicationType, ApplicationType.P_Name);
    ...
    // Model
    protected SingleAppModel model;
    ...
    // Search
    protected SingleAppSearchJfc jfcSearch;
    // hub Search
    protected SingleAppSearchJfc jfcSearchHub;
    // Add
    protected SingleAppSearchJfc jfcAdd;
    ...
    public SingleAppJfcBase() {
        this.model = new SingleAppModel();
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    
    public SingleAppJfcBase(Hub<SingleApp> hubSingleApp) {
        this.model = new SingleAppModel(hubSingleApp);
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    public SingleAppJfcBase(SingleAppModel modelSingleApp) {
        if (modelSingleApp == null) this.model = new SingleAppModel();
        else this.model = modelSingleApp;
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    ...
    // Model
    public SingleAppModel getModel() {
        return model;
    }
    ...
    public static Icon getIcon() {
        return Resource.getJarIcon("singleApp.gif");
    }
    public static Icon getTitleIcon() {
        return Resource.getJarIcon("singleApps.gif");
    }
    ...
    public OAMenuItem createNewMenuItem(Hub<SingleApp> hub) {
        if (!getModel().getAllowNew()) return null;
        OAMenuItem mi = new OAMenuItem(hub, OAMenuItem.NEW) {
            @Override
            public void afterActionPerformed() {
                // SingleAppJfcBase.this.getEditDialog(this).setVisible(true);
                SingleAppJfcBase.this.onNewSingleAppCreated();
    ...
    public OAMenuItem createInsertMenuItem(Hub<SingleApp> hub) {
        if (!getModel().getAllowNew()) return null;
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<SingleApp> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        if (hubRoot == null && OAString.isEmpty(leadingPropertyPath)) {
            hubRoot = getModel().getHub();
        }
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, SingleApp.P_ApplicationType, ApplicationType.P_Name), hubRoot, getHub()) {
            @Override
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
            ...
            public void onDoubleClick(Object obj, MouseEvent e) {
                SingleAppJfcBase.this.onDoubleClickTreeNode();
            }
            @Override
    ...
    public OAMenuItem createSearchMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), getModel().getDisplayName() + " search ...", Resource.getJarIcon("search.gif"), OAButton.SEARCH) {
            ...
            public Object getSearchObject() {
                SingleApp singleApp = SingleAppJfcBase.this.onSearch();
                return singleApp;
            }
            @Override
            public void afterActionPerformed() {
    ...
    public JMenuItem createHubSearchMenuItem() {
        ...
        mi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SingleAppJfcBase.this.onHubSearch();
           }
        });
        return mi;
    }
    ...
    public OALabel createLabel() {
        OALabel lbl = new OALabel(getHub(), OAString.cpp(SingleApp.P_ApplicationType, ApplicationType.P_Name), 14) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                SingleAppJfcBase.this.customizeRenderer(lbl, SingleAppJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
            @Override
            public String getToolTipText(Object object, int row, String defaultValue) {
                return SingleAppJfcBase.this.getToolTipText(SingleAppJfcBase.this.getHub().getAt(row), row, defaultValue);
            }
        };
    ...
    protected void customizeRenderer(JLabel lbl, SingleApp singleApp, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
    }
    protected String getToolTipText(SingleApp singleApp, int row, String defaultValue) {
        return defaultValue;
    }
    ...
    public OAComboBox createComboBox() {
        OAComboBox cbo = new OAComboBox(getHub(), OAString.cpp(SingleApp.P_ApplicationType, ApplicationType.P_Name), 14) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                SingleAppJfcBase.this.customizeRenderer(lbl, SingleAppJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
    ...
    public OAList createList() {
        OAList lst = new OAList(getHub(), OAString.cpp(SingleApp.P_ApplicationType, ApplicationType.P_Name), 12, 14) {
            @Override
            public void customizeRenderer(JLabel label, JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                SingleAppJfcBase.this.customizeRenderer(label, SingleAppJfcBase.this.getHub().getAt(index), isSelected, cellHasFocus, index, false, false);
            }
        };
    ...
    public OATree createSearchTree() {
        ...
        tnode.setIcon(SingleAppJfc.getTitleIcon());
        tree.add(tnode);
        node = new OATreeNode(SingleAppJfc.PP_Display, getHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                SingleAppJfcBase.this.onDoubleClickTreeNode();
            }
        ...
        node.setIcon(SingleAppJfc.getIcon());
        node.setForegroundColorProperty(SingleAppJfc.PP_ForeColor);
        node.setBackgroundColorProperty(SingleAppJfc.PP_BackColor);
        node.setIconColorProperty(SingleAppJfc.PP_IconColor);
        node.setImageProperty(SingleAppJfc.PP_Icon);
        node.setFontProperty(SingleAppJfc.PP_Font);
        node.setMaxImageHeight(20);
        node.setMaxImageWidth(32);
        tnode.add(node);
        return tree;
    ...
    protected String getToolTipText(OATable table, int row, int col, String defaultValue) {
        // SingleApp client = (SingleApp) table.getHub().getAt(row);
        // defaultValue = SingleAppDelegate.getToolTipText(client, true);
        return defaultValue;
    }
    public OATable createTable() {
        Hub<SingleApp> hubTable;
        if (getModel().getAllowTableFilter()) hubTable = new Hub<SingleApp>(SingleApp.class);
        ...
        OATable table = new OATable(hubTable) {
            ...
            public void onDoubleClick() {
                if (SingleAppJfcBase.this.getModel().getAllowGotoEdit()) {
                    SingleAppJfcBase.this.getEditDialog(this).setVisible(true);
                }
            }
        };
        ...
        // table.setColumnProperties(ModelDelegate.getProperties(), "SingleApp");
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        ...
        if (ApplicationTypeJfc.PP_IconColor != null) {
            lbl.setIconColorProperty(OAString.cpp(SingleApp.P_ApplicationType) + "." + ApplicationTypeJfc.PP_IconColor);
        }
        ...
        if (ApplicationVersionJfc.PP_IconColor != null) {
            lbl.setIconColorProperty(OAString.cpp(SingleApp.P_ApplicationVersion) + "." + ApplicationVersionJfc.PP_IconColor);
        }
    ...
    public void updateToolBar(final JToolBar toolBar, final ToolBarOptions tbo) {
        ...
        if (tbo.bLabel) {
            OALabel lbl = new OALabel(getHub(), OAString.cpp(SingleApp.P_ApplicationType, ApplicationType.P_Name));
            lbl.setToolTipTextPropertyPath(OAString.cpp(SingleApp.P_ApplicationType, ApplicationType.P_Name));
            lbl.setMaxCols(20);
            lbl.setFont(lbl.getFont().deriveFont(Font.ITALIC));
    ...
    public void addCustomCommands(JToolBar toolBar) {
        ...
        toolBar.add(createSingleAppRunMethodButton());
    }
    ...
    public JButton createGotoListButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SingleAppJfcBase.this.showCardPanel(SingleAppJfcBase.this.CARD_List);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createDownloadButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                SingleAppJfcBase.this.onDownload();
            }
        });
    ...
    protected void onDownload() {
        DownloadDialog dd = new DownloadDialog<SingleApp>(getHub());
    ...
    public JPanel createEditPanel(JTabbedPane tabbedPane, final boolean bUseCombinedDetail) {
        ...
        tabbedPane.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if (SingleAppJfcBase.this.TAB_PropertyValues == 0) return;
                final JTabbedPane tp = (JTabbedPane) e.getSource();
                if (tp.getSelectedIndex() != SingleAppJfcBase.this.TAB_PropertyValues) return;
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    ...
                    protected void done() {
                        if (ex != null) {
                            LOG.log(Level.WARNING, "UI exception creating UI for SingleApp", ex);
                        ...
                        tp.setComponentAt(SingleAppJfcBase.this.TAB_PropertyValues, panThis);
                    }
                };
                sw.execute();
            }
        ...
        if (getModel().getPropertyValuesModel().getCreateUI()) {
            if ((this.TAB_PropertyValues = tabbedPane.getTabCount()) == 0) {
                ...
                tabbedPane.setComponentAt(SingleAppJfcBase.this.TAB_PropertyValues, panThis);
            }
            else {
    ...
    public JDialog getEditDialog(Component comp) {
        ...
        if (jfcPropertyValues != null) {
            ...
            SingleAppJfc jfc = new SingleAppJfc(getModel());
    ...
    public OALabel createIdLabel() {
        OALabel lbl = new OALabel(getHub(), SingleApp.P_Id, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), SingleApp.P_Created, 15);
    ...
    public OATextField createNameTextField() {
        OATextField txt = new OATextField(getHub(), SingleApp.P_Name, 18);
    ...
    public OAButton createSingleAppRunMethodButton() {
        OAButton cmd = new OAButton(getHub(), "Run", getModel().getAllowMultiSelect() ? OAButton.HUB_METHOD : OAButton.OBJECT_METHOD) { 
            @Override
            public boolean onActionPerformed() throws Exception {
                if (SingleAppJfcBase.this.getModel().getAllowMultiSelect() && SingleAppJfcBase.this.getModel().getMultiSelectHub().getSize() > 0) {
                    for (SingleApp singleApp : SingleAppJfcBase.this.getModel().getMultiSelectHub()) {
                        if (!performAction(singleApp)) return false;
                    }
                }
                else {
                    SingleApp singleApp = SingleAppJfcBase.this.getHub().getAO();
                    performAction(singleApp);
                }
                return true;
            }
            boolean performAction(SingleApp singleApp) throws Exception {
        ...
        cmd.setConsoleProperty(SingleAppPP.runningApp().console());
        cmd.setMethodName(SingleApp.M_Run);
        cmd.setup();
        return cmd;
    }
    ...
    public ApplicationTypeJfc getApplicationTypeJfc() {
        ...
        jfcApplicationType = new ApplicationTypeJfc(getModel().getApplicationTypeSelectFromModel()) {
            ...
            protected ApplicationTypeSearchJfc getSearchJfc() {
                ...
                SingleAppJfcBase.this.getModel().getApplicationTypeSearchModel().getApplicationTypeSearch().setMaxResults(1000);
                jfcSearch = new ApplicationTypeSearchJfc(SingleAppJfcBase.this.getModel().getApplicationTypeSearchModel());
                return jfcSearch;
            }
        };
    ...
    public ApplicationVersionJfc getApplicationVersionJfc() {
        ...
        jfcApplicationVersion = new ApplicationVersionJfc(getModel().getApplicationVersionSelectFromModel()) {
            ...
            protected ApplicationVersionSearchJfc getSearchJfc() {
                if (jfcSearch != null) return jfcSearch;
                SingleAppJfcBase.this.getModel().getApplicationVersionSearchModel().getApplicationVersionSearch().setMaxResults(1000);
                jfcSearch = new ApplicationVersionSearchJfc(SingleAppJfcBase.this.getModel().getApplicationVersionSearchModel());
                return jfcSearch;
            }
        };
        ...
        jfcPropertyValues = new PropertyValueJfc(getModel().getPropertyValuesModel()) {
            ...
            public void showCardPanel(String name) {
                if (!bIsEmbedded) {
                    ...
                    SingleAppJfcBase.this.showCardPanel(name);
                    return;
                }
                if (name.equals(PropertyValueJfc.CARD_List)) {
                    SingleAppJfcBase.this.showCardPanel(CARD_Edit);
                    if (SingleAppJfcBase.this.TAB_PropertyValues >= 0) {
                        SingleAppJfcBase.this.getTabbedPane().setSelectedIndex(SingleAppJfcBase.this.TAB_PropertyValues);
                    }
                }
                    ...
                    SingleAppJfcBase.this.showCardPanel(CARD_PropertyValues);
                    super.showCardPanel(name);
                }
            }
            public JButton createGoBackButton() {
                JButton cmd = new JButton();
                cmd.setIcon(Resource.getJarIcon(Resource.getValue(Resource.IMG_GoBack)));
                cmd.setToolTipText("Go to " + SingleAppJfcBase.this.getModel().getDisplayName());
                cmd.addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        SingleAppJfcBase.this.showCardPanel(SingleAppJfcBase.this.CARD_Edit);
                        SingleAppJfcBase.this.getHub().resetAO(); // this will set selected treeNode
                    }
                });
                OAButton.setup(cmd);
                return cmd;
    ...
    protected void onNewSingleAppCreated() {
        onShowEditPanel();
    ...
    // Inner Search
    public SingleAppSearchJfc getSearchHubJfc() {
        if (jfcSearchHub != null) return jfcSearchHub;
        SingleAppSearchModel modelSearch = new SingleAppSearchModel();
        modelSearch.setSearchFromHub(getHub());
        jfcSearchHub = new SingleAppSearchJfc(modelSearch, true, getModel().getAllowMultiSelect()) {
            @Override
    ...
    protected void onHubSearch() {
        ...
        if (getModel().getAllowMultiSelect()) {
            ...
            for (SingleApp singleApp : getSearchHubJfc().getModel().getMultiSelectHub()) {
                if (getHub().contains(singleApp)) {
                    getModel().getMultiSelectHub().add(singleApp);
                }
            }
            getHub().setAO(getModel().getMultiSelectHub().getAt(0));
        }
        else {
            SingleApp singleApp = getSearchHubJfc().getSelected();
            if (singleApp != null) {
                if (getHub().contains(singleApp)) {
                    getHub().setAO(singleApp);
                }
            }
        }
    }
    ...
    protected SingleAppSearchJfc getSearchJfc() {
        if (jfcSearch == null) {
            jfcSearch = new SingleAppSearchJfc();
        }
        return jfcSearch;
    }
    protected SingleApp onSearch() {
        getSearchJfc().getModel().beforeInput();
        getSearchJfc().getDialog().setVisible(true);
        SingleApp singleApp = null;
        if (getSearchJfc().wasSelected()) singleApp = getSearchJfc().getSelected();
        return singleApp;
    }
    // Add
    protected SingleAppSearchJfc getAddJfc() {
        if (jfcAdd == null) {
            jfcAdd = new SingleAppSearchJfc();
        }
        return jfcAdd;
    }
    protected void onAdd() {
        ...
        SingleApp singleApp = getAddJfc().getSelected();
    ...
    public static void main(String[] args) {
        ...
        SingleAppJfc ui = new SingleAppJfc() {
            @Override
            protected SingleAppSearchJfc getSearchJfc() {
                if (this.jfcSearch == null) {
                    this.jfcSearch = new SingleAppSearchJfc(false) {
                        @Override
