...
import com.viaoa.appstore.model.oa.Environment;
...
public class EnvironmentJfcBase implements OAModelJfcInterface {
    protected static Logger LOG = Logger.getLogger(EnvironmentJfc.class.getName());
    
    public static final String PP_Display    = OAString.cpp(Environment.P_Name);
    ...
    protected static final String CARD_Servers = "Servers";
    protected int TAB_Servers = -1;
    ...
    // Search
    protected EnvironmentSearchJfc jfcSearch;
    // hub Search
    protected EnvironmentSearchJfc jfcSearchHub;
    // Add
    protected EnvironmentSearchJfc jfcAdd;
    ...
    protected ServerJfc jfcServers;
    
    public EnvironmentJfcBase() {
        this.model = new EnvironmentModel();
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    
    public EnvironmentJfcBase(Hub<Environment> hubEnvironment) {
        this.model = new EnvironmentModel(hubEnvironment);
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    public EnvironmentJfcBase(EnvironmentModel modelEnvironment) {
        if (modelEnvironment == null) this.model = new EnvironmentModel();
        else this.model = modelEnvironment;
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    ...
    public static Icon getIcon() {
        return Resource.getJarIcon("environment.gif");
    }
    public static Icon getTitleIcon() {
        return Resource.getJarIcon("environments.gif");
    }
    ...
    public OAMenuItem createNewMenuItem(Hub<Environment> hub) {
        if (!getModel().getAllowNew()) return null;
        OAMenuItem mi = new OAMenuItem(hub, OAMenuItem.NEW) {
            @Override
            public void afterActionPerformed() {
                // EnvironmentJfcBase.this.getEditDialog(this).setVisible(true);
                EnvironmentJfcBase.this.onNewEnvironmentCreated();
    ...
    public OAMenuItem createInsertMenuItem(Hub<Environment> hub) {
        if (!getModel().getAllowNew()) return null;
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<Environment> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        if (hubRoot == null && OAString.isEmpty(leadingPropertyPath)) {
            hubRoot = getModel().getHub();
        }
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, Environment.P_Name), hubRoot, getHub()) {
            @Override
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
            ...
            public void onDoubleClick(Object obj, MouseEvent e) {
                EnvironmentJfcBase.this.onDoubleClickTreeNode();
            }
            @Override
        ...
        OATreeTitleNode ttn;
        OATreeNode node2;
        ttn = getServersJfc().getTreeTitleNode();
        node2 = findNode(Environment.P_Servers, parentNodes);
        if (node2 == null) {
            node2 = getServersJfc().createTreeNode(Environment.P_Servers, null, true, nodes);
    ...
    public JPopupMenu createTreeNodePopupMenu(OATreeNode tn) {
        ...
        OAMenuItem mi;
        mi = getServersJfc().createNewMenuItem();
        if (mi != null) menu.add(mi);
        mi = getServersJfc().createAddMenuItem();
        if (mi != null) menu.add(mi);
    ...
    public OAMenuItem createSearchMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), getModel().getDisplayName() + " search ...", Resource.getJarIcon("search.gif"), OAButton.SEARCH) {
            ...
            public Object getSearchObject() {
                Environment environment = EnvironmentJfcBase.this.onSearch();
                return environment;
            }
            @Override
            public void afterActionPerformed() {
    ...
    public JMenuItem createHubSearchMenuItem() {
        ...
        mi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                EnvironmentJfcBase.this.onHubSearch();
           }
        });
        return mi;
    }
    ...
    public OALabel createLabel() {
        OALabel lbl = new OALabel(getHub(), OAString.cpp(Environment.P_Name), 15) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                EnvironmentJfcBase.this.customizeRenderer(lbl, EnvironmentJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
            @Override
            public String getToolTipText(Object object, int row, String defaultValue) {
                return EnvironmentJfcBase.this.getToolTipText(EnvironmentJfcBase.this.getHub().getAt(row), row, defaultValue);
            }
        };
    ...
    protected void customizeRenderer(JLabel lbl, Environment environment, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
    }
    protected String getToolTipText(Environment environment, int row, String defaultValue) {
        return defaultValue;
    }
    ...
    public OAComboBox createComboBox() {
        OAComboBox cbo = new OAComboBox(getHub(), OAString.cpp(Environment.P_Name), 15) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                EnvironmentJfcBase.this.customizeRenderer(lbl, EnvironmentJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
    ...
    public OAList createList() {
        OAList lst = new OAList(getHub(), OAString.cpp(Environment.P_Name), 12, 15) {
            @Override
            public void customizeRenderer(JLabel label, JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                EnvironmentJfcBase.this.customizeRenderer(label, EnvironmentJfcBase.this.getHub().getAt(index), isSelected, cellHasFocus, index, false, false);
            }
        };
    ...
    public OATree createSearchTree() {
        ...
        tree.add(tnode);
        node = new OATreeNode(EnvironmentJfc.PP_Display, ModelDelegate.getEnvironments().createSharedHub(), getHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                EnvironmentJfcBase.this.onDoubleClickTreeNode();
            }
    ...
    protected String getToolTipText(OATable table, int row, int col, String defaultValue) {
        // Environment client = (Environment) table.getHub().getAt(row);
        // defaultValue = EnvironmentDelegate.getToolTipText(client, true);
        return defaultValue;
    }
    public OATable createTable() {
        Hub<Environment> hubTable;
        if (getModel().getAllowTableFilter()) hubTable = new Hub<Environment>(Environment.class);
        ...
        OATable table = new OATable(hubTable) {
            ...
            public void onDoubleClick() {
                if (EnvironmentJfcBase.this.getModel().getAllowGotoEdit()) {
                    EnvironmentJfcBase.this.getEditDialog(this).setVisible(true);
                }
            }
        };
        ...
        // table.setColumnProperties(ModelDelegate.getProperties(), "Environment");
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        ...
        Hub h = OAObjectEnumDelegate.getDisplayNameValues(Environment.class, Environment.P_Type).createSharedHub();
    ...
    public void updateToolBar(final JToolBar toolBar, final ToolBarOptions tbo) {
        ...
        if (tbo.bLabel) {
            OALabel lbl = new OALabel(getHub(), OAString.cpp(Environment.P_Name));
            lbl.setToolTipTextPropertyPath(OAString.cpp(Environment.P_Name));
            lbl.setMaxCols(20);
            lbl.setFont(lbl.getFont().deriveFont(Font.ITALIC));
    ...
    public JButton createGotoListButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                EnvironmentJfcBase.this.showCardPanel(EnvironmentJfcBase.this.CARD_List);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createDownloadButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                EnvironmentJfcBase.this.onDownload();
            }
        });
    ...
    protected void onDownload() {
        DownloadDialog dd = new DownloadDialog<Environment>(getHub());
    ...
    public JPanel createEditOnePanel(JTabbedPane tp) {
        ...
        // cardPanel.add(getServersJfc().getCardPanel(), CARD_Servers); // this will be created when needed by showCardPanel(..)
        return pan;
    }
    ...
    public JPanel createEditPanel(JTabbedPane tabbedPane, final boolean bUseCombinedDetail) {
        ...
        Icon icon;
        icon = Resource.getJarIcon("server.gif");
        ...
        tabbedPane.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                ...
                if (EnvironmentJfcBase.this.TAB_Servers == 0) return;
                final JTabbedPane tp = (JTabbedPane) e.getSource();
                if (tp.getSelectedIndex() != EnvironmentJfcBase.this.TAB_Servers) return;
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    @Override
                    protected Void doInBackground() throws Exception {
                        try {
                            if (bUseCombinedDetail) panThis = getServersJfc().createCombinedPanel();
                            else panThis = getServersJfc().createTablePanel();
                        }
                        catch (Exception e) {
                            ex = e;
                        }
                    ...
                    protected void done() {
                        if (ex != null) {
                            LOG.log(Level.WARNING, "UI exception creating UI for Environment", ex);
                        ...
                        tp.setComponentAt(EnvironmentJfcBase.this.TAB_Servers, panThis);
                    }
                };
                sw.execute();
            }
        });
        if (getModel().getServersModel().getCreateUI()) {
            if ((this.TAB_Servers = tabbedPane.getTabCount()) == 0) {
                JPanel panThis;
                if (bUseCombinedDetail) panThis = getServersJfc().createCombinedPanel();
                else panThis = getServersJfc().createTablePanel();
                tabbedPane.setComponentAt(EnvironmentJfcBase.this.TAB_Servers, panThis);
            }
            else {
                tabbedPane.addTab("Servers", icon, new JLabel("loading ...", Resource.getJarIcon("wait.png"), JLabel.CENTER), "Servers");
            }
        }
        ...
        tabbedPane.addChangeListener(new ChangeListener() {
            ...
            public void stateChanged(ChangeEvent e) {
                if (panThis != null) return;
                if (EnvironmentJfcBase.this.TAB_MergeServerApplications == 0) return;
                final JTabbedPane tp = (JTabbedPane) e.getSource();
                if (tp.getSelectedIndex() != EnvironmentJfcBase.this.TAB_MergeServerApplications) return;
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    @Override
                    protected Void doInBackground() throws Exception {
                        try {
                    ...
                    protected void done() {
                        ...
                        if (panThis == null) panThis = new JPanel();
                        tp.setComponentAt(EnvironmentJfcBase.this.TAB_MergeServerApplications, panThis);
                    }
                };
                sw.execute();
            }
        ...
        if (getModel().getMergeServerApplicationsModel().getCreateUI()) {
            if ((this.TAB_MergeServerApplications = tabbedPane.getTabCount()) == 0) {
                ...
                tabbedPane.setComponentAt(EnvironmentJfcBase.this.TAB_MergeServerApplications, panThis);
            }
            else {
                tabbedPane.addTab("All Applications", icon, new JLabel("loading ...", Resource.getJarIcon("wait.png"), JLabel.CENTER), "Server Applications");
            }
        }
        panel = panMain;
        return panel;
    ...
    public JDialog getEditDialog(Component comp) {
        ...
        if (jfcMergeServerApplications != null) {
            ...
            EnvironmentJfc jfc = new EnvironmentJfc(getModel());
    ...
    public OALabel createIdLabel() {
        OALabel lbl = new OALabel(getHub(), Environment.P_Id, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), Environment.P_Created, 15);
    ...
    public OATextField createNameTextField() {
        OATextField txt = new OATextField(getHub(), Environment.P_Name, 15);
    ...
    public OATextField createAbbrevNameTextField() {
        OATextField txt = new OATextField(getHub(), Environment.P_AbbrevName, 5);
        txt.setMinimumColumns(0);
    ...
    public OAComboBox createTypeComboBox() {
        Hub<String> hub = OAObjectEnumDelegate.getDisplayNameValues(Environment.class, Environment.P_Type).createSharedHub();
        hub.setLinkHubOnPos(getHub(), Environment.P_Type);
    ...
    public OALabel createSeqLabel() {
        OALabel lbl = new OALabel(getHub(), Environment.P_Seq, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
            ...
            public void showCardPanel(String name) {
                ...
                if (name.equals(ServerApplicationJfc.CARD_List)) {
                    ...
                    if (EnvironmentJfcBase.this.TAB_MergeServerApplications >= 0) {
                        EnvironmentJfcBase.this.getTabbedPane().setSelectedIndex(EnvironmentJfcBase.this.TAB_MergeServerApplications);
                    }
                }
                    ...
                    EnvironmentJfcBase.this.showCardPanel(CARD_MergeServerApplications);
                    super.showCardPanel(name);
                }
            }
            public JButton createGoBackButton() {
                JButton cmd = new JButton();
                cmd.setIcon(Resource.getJarIcon(Resource.getValue(Resource.IMG_GoBack)));
                cmd.setToolTipText("Go to " + EnvironmentJfcBase.this.getModel().getDisplayName());
                cmd.addActionListener(new ActionListener() {
                    @Override
                    public void actionPerformed(ActionEvent e) {
                        EnvironmentJfcBase.this.showCardPanel(EnvironmentJfcBase.this.CARD_Edit);
                        EnvironmentJfcBase.this.getHub().resetAO(); // this will set selected treeNode
                    }
                });
                OAButton.setup(cmd);
                return cmd;
    ...
    public ServerJfc getServersJfc() {
        if (jfcServers == null) {
            jfcServers = createServersJfc();
        }
        return jfcServers;
    }
    ...
    public ServerJfc createServersJfc(final boolean bIsEmbedded) {
            ...
            public void showCardPanel(String name) {
                ...
                if (name.equals(ServerJfc.CARD_List)) {
                    ...
                    if (EnvironmentJfcBase.this.TAB_Servers >= 0) {
                        EnvironmentJfcBase.this.getTabbedPane().setSelectedIndex(EnvironmentJfcBase.this.TAB_Servers);
                    }
                }
                else if (name.equals(ServerJfcBase.CARD_Edit)) {
                    EnvironmentJfcBase.this.showCardPanel(CARD_Edit);
                    if (EnvironmentJfcBase.this.TAB_Servers >= 0) {
                        EnvironmentJfcBase.this.getTabbedPane().setSelectedIndex(EnvironmentJfcBase.this.TAB_Servers);
                    }
                    ...
                    EnvironmentJfcBase.this.showCardPanel(CARD_Servers);
                    super.showCardPanel(name);
                }
            }
            public JButton createGoBackButton() {
        ...
        jfcServers.setLevel(getLevel()+1);
        OAModelJfcUtil.setParent(jfcServers, this);
        return jfcServers;
    }
    // OnShowCommands
    public void showCardPanel(String name) {
        ...
        if (name.equalsIgnoreCase(CARD_MergeServerApplications)) {
        ...
        else if (name.equalsIgnoreCase(CARD_Servers)) {
            if ( !OAArray.contains(cardPanel.getComponents(), getServersJfc().getCardPanel()) ) {
                cardPanel.add(getServersJfc().getCardPanel(), CARD_Servers);
            }
        }
    ...
    protected void onNewEnvironmentCreated() {
        onShowEditPanel();
    ...
    // Inner Search
    public EnvironmentSearchJfc getSearchHubJfc() {
        if (jfcSearchHub != null) return jfcSearchHub;
        EnvironmentSearchModel modelSearch = new EnvironmentSearchModel();
        modelSearch.setSearchFromHub(getHub());
        jfcSearchHub = new EnvironmentSearchJfc(modelSearch, true, getModel().getAllowMultiSelect()) {
            @Override
    ...
    protected void onHubSearch() {
        ...
        if (getModel().getAllowMultiSelect()) {
            ...
            for (Environment environment : getSearchHubJfc().getModel().getMultiSelectHub()) {
                if (getHub().contains(environment)) {
                    getModel().getMultiSelectHub().add(environment);
                }
            }
            getHub().setAO(getModel().getMultiSelectHub().getAt(0));
        }
        else {
            Environment environment = getSearchHubJfc().getSelected();
            if (environment != null) {
                if (getHub().contains(environment)) {
                    getHub().setAO(environment);
                }
            }
        }
    }
    ...
    protected EnvironmentSearchJfc getSearchJfc() {
        if (jfcSearch == null) {
            jfcSearch = new EnvironmentSearchJfc();
        }
        return jfcSearch;
    }
    protected Environment onSearch() {
        getSearchJfc().getModel().beforeInput();
        getSearchJfc().getDialog().setVisible(true);
        Environment environment = null;
        if (getSearchJfc().wasSelected()) environment = getSearchJfc().getSelected();
        return environment;
    }
    // Add
    protected EnvironmentSearchJfc getAddJfc() {
        if (jfcAdd == null) {
            jfcAdd = new EnvironmentSearchJfc();
        }
        return jfcAdd;
    }
    protected void onAdd() {
        ...
        Environment environment = getAddJfc().getSelected();
    ...
    public static void main(String[] args) {
        ...
        EnvironmentJfc ui = new EnvironmentJfc(ModelDelegate.getEnvironments().createSharedHub()) {
            @Override
            protected EnvironmentSearchJfc getSearchJfc() {
                if (this.jfcSearch == null) {
                    this.jfcSearch = new EnvironmentSearchJfc(false) {
                        @Override
