...
public class MySingleUserAppsBarBase2 {
    private static Logger LOG = Logger.getLogger(MySingleUserAppsBarBase2.class.getName());
    ...
    public MySingleUserAppsBarBase2() {
...
//qqqqqqqqqqqqqqqqqqqqqq use AppUserJfcBase.SingleAppJfc
        ...
        AppUserJfc jfcAppUser = new AppUserJfc(modelAppUser) {
            ...
            public void showCardPanel(final String name) {
                MySingleUserAppsBarBase2.this.cardLayout.show(MySingleUserAppsBarBase2.this.cardPanel, CARD_AppUserSingleApps);
                if (panx != null) return;
                ...
                SwingWorker<Void, Void> sw = new SwingWorker<Void, Void>() {
                    ...
                    protected void done() {
                        ...
                        MySingleUserAppsBarBase2.this.cardPanel.add(panx, CARD_AppUserSingleApps);
                        showCardPanel(name);
                    }
                };
                sw.execute();
    ...
    protected OATree getTree() {
        ...
        tree = new OATree(18) {
            ...
            public void nodeSelected(OATreeNode node) {
                ...
                if (node == null) {
                    MySingleUserAppsBarBase2.this.cardLayout.show(MySingleUserAppsBarBase2.this.cardPanel, MySingleUserAppsBarBase2.this.CARD_Splash);
                }
            }
        };
