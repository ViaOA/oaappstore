    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.viaoa.appstore.webservice.client.hello.wsimport.HelloService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.viaoa.appstore.webservice.client.hello.wsimport.HelloService.class.getResource(".");
