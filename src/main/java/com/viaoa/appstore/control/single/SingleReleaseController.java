...
public class SingleReleaseController {
    private static Logger LOG = Logger.getLogger(SingleReleaseController.class.getName());
  ...
  //QQQQQQQQQQQQQQQQQQQQQQ NOT Used qqqqqqqqqqqqq
    ...
    public static void main(String[] args) throws Exception {
        SingleReleaseController src = new SingleReleaseController();
        boolean b = src.hasUpdate();
        if (b) {
            src.getUpdate();
            src.updateConfig();
        }
