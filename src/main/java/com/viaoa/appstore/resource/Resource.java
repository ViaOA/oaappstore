...
package com.viaoa.appstore.resource;
...
public class Resource {
	...
	public static OAProperties getBundleProperties() {
		...
		try {
			InputStream resourceAsStream = OAObject.class.getResourceAsStream("/META-INF/maven/com.viaoa.appstore/oaAppStore/pom.properties");
