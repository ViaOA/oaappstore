...
if (form == null) {
    ...
    BsDialog comp = new BsDialog("dlgx") {
        int cnt;
...
<fieldset>
  <legend>Demo BsDialog</legend>
  <label id="lbl">Test BsDialog </label><br> 
  click the "visible"" checkbox to display dialog in upper right
  
  <div id="dlgx"><h3>This is a bsDialog dialog description for testing</h3></div> <br>
