...
formId = "baseComponent";
  ...
  // oasession.setDebug(false); //qqqqqqq

  if (form == null) {
      form = oasession.createRequestForm(formId);
      OAComponent comp = new OAComponent("txt");
      ...
      */
      ...
      // comp.setEventType(OAComponent.EventType.OnChange);
...
// Build out all Java classes for each HTML <input type=??>
      ...
      comp = new OAComponent("chk");
      //comp.setEnabled(false);
      //comp.setRequired(true);
      form.add(comp);

      comp = new OAComponent("span");
