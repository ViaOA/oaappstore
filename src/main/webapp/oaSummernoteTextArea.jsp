...
if (form == null) {
    ...
    OASummernoteTextArea comp = new OASummernoteTextArea("txta", hub, AppUser.P_Note) {
        int cnt;
...
<fieldset>
  <legend>Demo OASummernoteTextArea</legend>
  <label id="lbl"></label> Test OASummernoteTextArea <textarea id="txta"></textarea> <br>
