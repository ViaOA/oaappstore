...
if (form == null) {
    ...
    OAInputTime comp = new OAInputTime("time", hub, AppUser.P_CurrentTime) {
        int cnt;
...
<fieldset>
  <legend>Demo OAInputTime</legend>
  <label id="lbl">Test OAInputTime <input id="time" type="time"></label> <br>
