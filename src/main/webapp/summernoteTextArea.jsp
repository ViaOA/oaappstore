...
if (form == null) {
    ...
    SummernoteTextArea comp = new SummernoteTextArea("txta") {
        int cnt;
...
<fieldset>
  <legend>Demo SummernoteTextArea</legend>
  <label id="lbl">Test SummernoteTextArea <textarea id="txta"></textarea></label> <br>
