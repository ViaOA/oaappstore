...
if (form == null) {
    ...
    OAInputDateTime comp = new OAInputDateTime("dt", hub, AppUser.P_Now) {
        int cnt;
...
<p>
Note: qqqqqqqq this does not have a value oaproperty ... using calc for Now()
<p>

<fieldset>
  <legend>Demo OAInputDateTime</legend>
  <label id="lbl">Test OAInputDateTime <input id="dt" type="datetime"></label> <br>
