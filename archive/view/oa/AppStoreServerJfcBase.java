...
import com.viaoa.appstore.model.oa.AppStoreServer;
...
public class AppStoreServerJfcBase implements OAModelJfcInterface {
    protected static Logger LOG = Logger.getLogger(AppStoreServerJfc.class.getName());
    
    public static final String PP_Display    = OAString.cpp(AppStoreServer.P_Name);
    ...
    // Model
    protected AppStoreServerModel model;
    ...
    // Search
    protected AppStoreServerSearchJfc jfcSearch;
    // hub Search
    protected AppStoreServerSearchJfc jfcSearchHub;
    // Add
    protected AppStoreServerSearchJfc jfcAdd;
    ...
    public AppStoreServerJfcBase() {
        this.model = new AppStoreServerModel();
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    
    public AppStoreServerJfcBase(Hub<AppStoreServer> hubAppStoreServer) {
        this.model = new AppStoreServerModel(hubAppStoreServer);
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    public AppStoreServerJfcBase(AppStoreServerModel modelAppStoreServer) {
        if (modelAppStoreServer == null) this.model = new AppStoreServerModel();
        else this.model = modelAppStoreServer;
        this.model.setForJfc(true);
        OAModelJfcUtil.register(this);
    }
    ...
    // Model
    public AppStoreServerModel getModel() {
        return model;
    }
    ...
    public static Icon getIcon() {
        return Resource.getJarIcon("appStoreServer.gif");
    }
    public static Icon getTitleIcon() {
        return Resource.getJarIcon("appStoreServers.gif");
    }
    ...
    public OAMenuItem createAddMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), OAButton.ADD_MANUAL) {
            ...
            public boolean onActionPerformed() throws Exception {
                AppStoreServerJfcBase.this.onAdd();
                return true;
            }
        };
    ...
    public OAMenuItem createNewMenuItem(Hub<AppStoreServer> hub) {
        if (!getModel().getAllowNew()) return null;
        OAMenuItem mi = new OAMenuItem(hub, OAMenuItem.NEW) {
            @Override
            public void afterActionPerformed() {
                // AppStoreServerJfcBase.this.getEditDialog(this).setVisible(true);
                AppStoreServerJfcBase.this.onNewAppStoreServerCreated();
    ...
    public OAMenuItem createInsertMenuItem(Hub<AppStoreServer> hub) {
        if (!getModel().getAllowNew()) return null;
    ...
    public OATreeNode createTreeNode(String leadingPropertyPath, Hub<AppStoreServer> hubRoot, boolean bIncludeChildren, OATreeNode ... parentNodes) {
        if (hubRoot == null && OAString.isEmpty(leadingPropertyPath)) {
            hubRoot = getModel().getHub();
        }
        OATreeNode node = new OATreeNode(OAString.cpp(leadingPropertyPath, AppStoreServer.P_Name), hubRoot, getHub()) {
            @Override
            public void objectSelected(Object obj) {
                super.objectSelected(obj);
                AppStoreServerJfcBase.this.onShowEditPanel();
            }
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                AppStoreServerJfcBase.this.onDoubleClickTreeNode();
            }
            @Override
    ...
    public OAMenuItem createSearchMenuItem() {
        ...
        OAMenuItem mi = new OAMenuItem(getHub(), getModel().getDisplayName() + " search ...", Resource.getJarIcon("search.gif"), OAButton.SEARCH) {
            ...
            public Object getSearchObject() {
                AppStoreServer appStoreServer = AppStoreServerJfcBase.this.onSearch();
    ...
    public JMenuItem createHubSearchMenuItem() {
        ...
        mi.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                AppStoreServerJfcBase.this.onHubSearch();
           }
        });
        return mi;
    }
    ...
    public OALabel createLabel() {
        OALabel lbl = new OALabel(getHub(), OAString.cpp(AppStoreServer.P_Name), 20) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                AppStoreServerJfcBase.this.customizeRenderer(lbl, AppStoreServerJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
            @Override
            public String getToolTipText(Object object, int row, String defaultValue) {
                return AppStoreServerJfcBase.this.getToolTipText(AppStoreServerJfcBase.this.getHub().getAt(row), row, defaultValue);
            }
        };
        lbl.setMaximumColumns(70);
    ...
    protected void customizeRenderer(JLabel lbl, AppStoreServer appStoreServer, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
    }
    protected String getToolTipText(AppStoreServer appStoreServer, int row, String defaultValue) {
        return defaultValue;
    }
    ...
    public OAComboBox createComboBox() {
        OAComboBox cbo = new OAComboBox(getHub(), OAString.cpp(AppStoreServer.P_Name), 20) {
            @Override
            public void customizeRenderer(JLabel lbl, Object object, Object value, boolean isSelected, boolean hasFocus, int row, boolean wasChanged, boolean wasMouseOver) {
                AppStoreServerJfcBase.this.customizeRenderer(lbl, AppStoreServerJfcBase.this.getHub().getAt(row), isSelected, hasFocus, row, wasChanged, wasMouseOver);
            }
    ...
    public OAList createList() {
        OAList lst = new OAList(getHub(), OAString.cpp(AppStoreServer.P_Name), 12, 20) {
            @Override
            public void customizeRenderer(JLabel label, JList list, Object value, int index, boolean isSelected, boolean cellHasFocus) {
                ...
                AppStoreServerJfcBase.this.customizeRenderer(label, AppStoreServerJfcBase.this.getHub().getAt(index), isSelected, cellHasFocus, index, false, false);
            }
        };
        lst.setMinimumColumns(6);
        lst.setMaximumColumns(70);
    ...
    public OATree createSearchTree() {
        ...
        tnode.setIcon(AppStoreServerJfc.getTitleIcon());
        tree.add(tnode);
        node = new OATreeNode(AppStoreServerJfc.PP_Display, ModelDelegate.getAppStoreServers().createSharedHub(), getHub()) {
            @Override
            public void onDoubleClick(Object obj, MouseEvent e) {
                AppStoreServerJfcBase.this.onDoubleClickTreeNode();
            }
        ...
        node.setIcon(AppStoreServerJfc.getIcon());
        node.setForegroundColorProperty(AppStoreServerJfc.PP_ForeColor);
        node.setBackgroundColorProperty(AppStoreServerJfc.PP_BackColor);
        node.setIconColorProperty(AppStoreServerJfc.PP_IconColor);
        node.setImageProperty(AppStoreServerJfc.PP_Icon);
        node.setFontProperty(AppStoreServerJfc.PP_Font);
        node.setMaxImageHeight(20);
        node.setMaxImageWidth(32);
        tnode.add(node);
        return tree;
    ...
    protected String getToolTipText(OATable table, int row, int col, String defaultValue) {
        // AppStoreServer client = (AppStoreServer) table.getHub().getAt(row);
        // defaultValue = AppStoreServerDelegate.getToolTipText(client, true);
        return defaultValue;
    }
    public OATable createTable() {
        Hub<AppStoreServer> hubTable;
        if (getModel().getAllowTableFilter()) hubTable = new Hub<AppStoreServer>(AppStoreServer.class);
        ...
        OATable table = new OATable(hubTable) {
            ...
            public void onDoubleClick() {
                if (AppStoreServerJfcBase.this.getModel().getAllowGotoEdit()) {
                    AppStoreServerJfcBase.this.getEditDialog(this).setVisible(true);
                }
            }
        };
        ...
        // table.setColumnProperties(ModelDelegate.getProperties(), "AppStoreServer");
    ...
    public void createTableColumns(OATable table) {
        ...
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(AppStoreServer.P_Name));
        }
        tc = table.addColumn("Server", 20, createServerTextField());
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(AppStoreServer.P_Server));
        }
    }
    ...
    protected void createReadOnlyTableColumns(OATable table) {
        OALabel lbl;
        OATableColumn tc;
        lbl = new OALabel(getHub(), AppStoreServer.P_Name, 20);
        tc = table.addColumn("Name", 20, lbl);
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(AppStoreServer.P_Name));
        }
        lbl = new OALabel(getHub(), AppStoreServer.P_Server, 20);
        tc = table.addColumn("Server", 20, lbl);
        if (getModel().getAllowTableFilter()) {
            tc.setFilterComponent(new OATextFieldFilter(AppStoreServer.P_Server));
        }
    }
    ...
    public void updateToolBar(final JToolBar toolBar, final ToolBarOptions tbo) {
        ...
        if (tbo.bLabel) {
            OALabel lbl = new OALabel(getHub(), OAString.cpp(AppStoreServer.P_Name));
            lbl.setToolTipTextPropertyPath(OAString.cpp(AppStoreServer.P_Name));
            lbl.setMaxCols(20);
            lbl.setFont(lbl.getFont().deriveFont(Font.ITALIC));
    ...
    public void addCustomCommands(JToolBar toolBar) {
        ...
        toolBar.add(createAppStoreServerRunMethodButton());
    }
    ...
    public JButton createGotoListButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                AppStoreServerJfcBase.this.showCardPanel(AppStoreServerJfcBase.this.CARD_List);
            }
        });
        OAButton.setup(cmd);
        return cmd;
    ...
    public JButton createDownloadButton() {
        ...
        cmd.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                AppStoreServerJfcBase.this.onDownload();
            }
        });
    ...
    protected void onDownload() {
        DownloadDialog dd = new DownloadDialog<AppStoreServer>(getHub());
        addDownloadProperties(dd);
        dd.download();
    }
    protected void addDownloadProperties(DownloadDialog dd) {
        dd.addProperty("Id", AppStoreServer.P_Id);
        dd.addProperty("name", AppStoreServer.P_Name);
        dd.addProperty("server", AppStoreServer.P_Server);
    }
    // Card Panel
    ...
    public JDialog getEditDialog(Component comp) {
        ...
        AppStoreServerJfc jfc = new AppStoreServerJfc(getModel());
    ...
    public OALabel createIdLabel() {
        OALabel lbl = new OALabel(getHub(), AppStoreServer.P_Id, 6);
        lbl.setMaximumColumns(8);
        return lbl;
    }
    
    public OADateTimeTextField createCreatedDateTimeTextField() {
        OADateTimeTextField dttxt = new OADateTimeTextField(getHub(), AppStoreServer.P_Created, 15);
    ...
    public OATextField createNameTextField() {
        OATextField txt = new OATextField(getHub(), AppStoreServer.P_Name, 20);
    ...
    public OATextField createServerTextField() {
        OATextField txt = new OATextField(getHub(), AppStoreServer.P_Server, 20);
        txt.setMinimumColumns(0);
    ...
    public OAConsole createConsoleConsole() {
        OAConsole con = new OAConsole(getHub(), AppStoreServer.P_Console, 22);
        return con;
    }
    public OALabel createConsoleLabel() {
        OALabel lbl = new OALabel(getHub(), AppStoreServer.P_Console, 22);
        return lbl;
    }
    
    public OAButton createAppStoreServerRunMethodButton() {
        OAButton cmd = new OAButton(getHub(), "Run", getModel().getAllowMultiSelect() ? OAButton.HUB_METHOD : OAButton.OBJECT_METHOD) { 
            @Override
            public boolean onActionPerformed() throws Exception {
                if (AppStoreServerJfcBase.this.getModel().getAllowMultiSelect() && AppStoreServerJfcBase.this.getModel().getMultiSelectHub().getSize() > 0) {
                    for (AppStoreServer appStoreServer : AppStoreServerJfcBase.this.getModel().getMultiSelectHub()) {
                        if (!performAction(appStoreServer)) return false;
                    }
                }
                else {
                    AppStoreServer appStoreServer = AppStoreServerJfcBase.this.getHub().getAO();
                    performAction(appStoreServer);
                }
                return true;
            }
            boolean performAction(AppStoreServer appStoreServer) throws Exception {
                if (appStoreServer == null) return false;
                appStoreServer.run();
                return true;
            }
        };
        ...
        cmd.setConsoleProperty(AppStoreServerPP.console());
        cmd.setMethodName(AppStoreServer.M_Run);
        cmd.setup();
        return cmd;
    }
    ...
    protected void onNewAppStoreServerCreated() {
        onShowEditPanel();
    }
    ...
    // Inner Search
    public AppStoreServerSearchJfc getSearchHubJfc() {
        if (jfcSearchHub != null) return jfcSearchHub;
        AppStoreServerSearchModel modelSearch = new AppStoreServerSearchModel();
        modelSearch.setSearchFromHub(getHub());
        jfcSearchHub = new AppStoreServerSearchJfc(modelSearch, true, getModel().getAllowMultiSelect()) {
            @Override
    ...
    protected void onHubSearch() {
        ...
        if (getModel().getAllowMultiSelect()) {
            ...
            for (AppStoreServer appStoreServer : getSearchHubJfc().getModel().getMultiSelectHub()) {
                if (getHub().contains(appStoreServer)) {
                    getModel().getMultiSelectHub().add(appStoreServer);
                }
            }
            getHub().setAO(getModel().getMultiSelectHub().getAt(0));
        }
        else {
            AppStoreServer appStoreServer = getSearchHubJfc().getSelected();
            if (appStoreServer != null) {
                if (getHub().contains(appStoreServer)) {
                    getHub().setAO(appStoreServer);
                }
            }
        }
    }
    // Search
    protected AppStoreServerSearchJfc getSearchJfc() {
        if (jfcSearch == null) {
            jfcSearch = new AppStoreServerSearchJfc();
        }
        return jfcSearch;
    }
    protected AppStoreServer onSearch() {
        getSearchJfc().getModel().beforeInput();
        getSearchJfc().getDialog().setVisible(true);
        AppStoreServer appStoreServer = null;
        if (getSearchJfc().wasSelected()) appStoreServer = getSearchJfc().getSelected();
        return appStoreServer;
    }
    // Add
    protected AppStoreServerSearchJfc getAddJfc() {
        if (jfcAdd == null) {
            jfcAdd = new AppStoreServerSearchJfc();
        }
        return jfcAdd;
    }
    protected void onAdd() {
        ...
        AppStoreServer appStoreServer = getAddJfc().getSelected();
        if (appStoreServer == null) return;
    ...
    public static void main(String[] args) {
        ...
        AppStoreServerJfc ui = new AppStoreServerJfc(ModelDelegate.getAppStoreServers().createSharedHub()) {
            @Override
            protected AppStoreServerSearchJfc getSearchJfc() {
                if (this.jfcSearch == null) {
                    this.jfcSearch = new AppStoreServerSearchJfc(false) {
                        @Override
